...
ALTER TABLE "project" ADD CONSTRAINT "project_category_id_category_project_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."category_project"("id") ON DELETE cascade ON UPDATE no action;