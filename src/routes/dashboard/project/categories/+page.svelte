<script lang="ts">
	...
	const dt = createDataTable(
		data.getData,
		'?/delete',
		'/dashboard/project/categories/form?id=',
		'categoriesProjectRows' // key untuk localStorage
	);
...
<div class="space-y-4">
	...
	<div class="flex items-center justify-between">
		<h1 class="text-xl font-bold">Data Project Categories</h1>
		<Button onclick={() => goto('/dashboard/project/categories/form')}>Create New</Button>
	</div>
